...
def attack(char_name: str, char_class: str) -> str:
    """Показывает уровень урона противника."""
...
def defence(char_name: str, char_class: str) -> str:
    """Показывает уровень блока урона противника."""
    if char_class == 'warrior':
...
def main() -> None:
    ...
    print(f'Здравствуй, {char_name}! '
          'Сеgit kloneйчас твоя выносливость — 80, атака — 5 и защита — 10.')
